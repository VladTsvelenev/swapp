...
#define PROT_RWX     0x7
#define PROT_WT      0x8   /* Write-through */
#define PROT_WC      0x10  /* Cache disable (Upgradable to Write-combining via MTRRs) */
...
enum PageState {
    ...
    SWAPPED_PAGE = 0x1000000,   /* Page is swapped */
};
...
int map_page(struct AddressSpace *spc, uintptr_t addr, struct Page *page, int flags);
