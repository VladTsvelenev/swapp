...
#define SWAP_SIZE   (PAGE_SIZE + sizeof(swap_info)) * SWAP_AMOUNT // 16 бит
#define SWAP_ZONE   (KERN_HEAP_START) - SWAP_SIZE

#define LRU_SIZE    SWAP_AMOUNT * sizeof(*lru_list)
#define LRU_ZONE    SWAP_ZONE - LRU_SIZE

#define LZ4_COMPRESSBOUND(isize)  ((unsigned)(isize) > (unsigned)LZ4_MAX_INPUT_SIZE ? 0 : (isize) + ((isize)/255) + 16)
#define COMP_SIZE   LZ4_COMPRESSBOUND(PAGE_SIZE) //4128
#define COMP_ZONE   LRU_ZONE - COMP_SIZE

/* Memory-mapped FrameBuffer */
#define FRAMEBUFFER KERN_HEAP_START

#define MAX_USER_READABLE (FRAMEBUFFER - HUGE_PAGE_SIZE)
